...
import org.datayoo.sengee.op.processing.r.join.UnionDescriptor;
...
@OpDefiner(name = "Union",
    ...
    parameters = "",
    compoxes = {})
public class Union extends BaseSetOperator {

  private boolean deDuplication = true;

  public Union(FlowNodeMetadata operatorMetadata, FlowNode parent,
  ...
  protected void presetAttributes(GroupParameter groupParameter) {
    deDuplication = parameters.getParameterValueAsBoolean(
        UnionDescriptor.PARAM_DE_DUPLICATION);
  }
}
