...
@OpDefiner(name = "MatchFilter",
    ...
    parameters =
        "<parameters><parametergroup name=\"general\" c_Alias=\"一般\" c_Compox=\"sightx-tab\">"
            ...
            + "<parameter name=\"dataColumn\" c_Option=\"false\" c_Alias=\"待过滤数据列\" c_Compox=\"sengee-dataIn:all-column-selector\"></parameter>"
            + "</head>" + "</parametertable>"
            + "</parametergroup></parameters>",
    compoxes = {})
public class MatchFilterDescriptor
    extends AbstractProcessingDescriptor {

  public static final String PARAM_SRC_COLUMN = "srcColumn";
  public static final String PARAM_COLUMN = "dataColumn";

  public MatchFilterDescriptor(FlowNodeMetadata flowNodeMetadata,
