 ...
 * @author hcy
 * @version 1.0
 * @className FlinkSQLQueryDescriptor
 * @description flink cep sql
 * @date 2/18/2023 3:33 PM
 **/
@OpDefiner(name = "FlinkSQLQuery",
    ...
    parameters =
        "<parameters><parametergroup name=\"general\" c_Alias=\"一般\" c_Compox=\"sightx-tab\">"
            ...
            + "<parameter name=\"tableName\" c_Alias=\"表名\" c_Option=\"false\"></parameter>"
            + "<parameter name=\"parallelism\" c_Alias=\"并行度\" c_Option=\"false\"></parameter>"
    ...
    compoxes = {})
public class FlinkSQLQueryDescriptor extends AbstractProcessingDescriptor
    implements TableListDescriptor {

  public final static String PARAM_SQL = "sql";
  public final static String PARAM_TABLE_NAME = "tableName";
  public final static String PARAM_PARALLELISM = "parallelism";

  private String sql;
  private String tableName;
  protected List<ColumnMappingEntry> columnMappingEntries;

  public FlinkSQLQueryDescriptor(FlowNodeMetadata flowNodeMetadata,
  ...
  protected void readParameters() {
    sql = parameters.getParameterValue(PARAM_SQL);
    tableName = parameters.getParameterValue(PARAM_TABLE_NAME, "defaultView");
  ...
  protected void validateParameters() {
    if (sql.isEmpty()) {
      throw new OperationRuntimeException(OperatorsI18nMessageResource.format(
          OperatorsExceptionConstants.ECM_PARAM_EMPTY, this.alias, PARAM_SQL));
    }
    try {
  ...
  @Override
  public List<String> listSchemas(String catalog,String s) {
    return Collections.emptyList();
  }

  @Override
  public List<TableEntry> listTables(String catalog,String s, String s1) {
