...
@OpDefiner(name = "Sampling",
    ...
    parameters =
        "<parameters><parametergroup name=\"general\" c_Alias=\"一般\" c_Compox=\"sightx-tab\">"
            ...
            + "<parameter name=\"sampleProbability\" c_Option=\"false\" c_Alias=\"抽样概率\" c_Compox=\"sampling-sampleProbability\">0.0</parameter>"
    ...
    compoxes = { @Compox(id = "sampleCtrl",
        ...
        dataDescriptor = @DataDesc(defaultValue = "ABSOLUTE",
            data =
                "[{\"label\": \"绝对值\", \"value\": \"ABSOLUTE\"}, {\"label\": \"相对比例\", "
                    + "\"value\": \"RELATIVE\"}, {\"label\": \"抽样概率\", \"value\": \"PROBABILITY\"}]")),
        ...
        @Compox(id = "sampling-sampleProbability",
            parentId = "sightx-double",
            visibleDescriptors = {
                @VisibleDesc(visibleType = VisibleType.VISIBLE,
                    condition = "sample == \"PROBABILITY\"")
            })
    })
public class SamplingDescriptor extends AbstractProcessingDescriptor {
  ...
  public static final String PARAM_SAMPLE_PROBABILITY = "sampleProbability";
  ...
  public SamplingDescriptor(FlowNodeMetadata flowNodeMetadata, FlowNode parent,
  ...
  protected void readParameters() {
    ...
    sampleProbability = parameters
        .getParameterValueAsDouble(PARAM_SAMPLE_PROBABILITY, 0.0d);
  }
  ...
  protected void validateParameters() {
    ...
    } else if (sample == SampleCtrl.PROBABILITY) {
      if (sampleProbability <= 0.0d || sampleProbability >= 1.0d) {
        throw new OperationRuntimeException(OperatorsI18nMessageResource
            .format(OperatorsExceptionConstants.ECM_OPD_COL_BETWEEN, this.alias,
                PARAM_SAMPLE_PROBABILITY, "0", "1"));
      }
    } else {
      throw new OperationRuntimeException(OperatorsI18nMessageResource
