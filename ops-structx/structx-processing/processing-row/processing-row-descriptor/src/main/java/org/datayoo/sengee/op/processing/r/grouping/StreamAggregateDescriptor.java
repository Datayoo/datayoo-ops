...
public class StreamAggregateDescriptor extends AbstractProcessingDescriptor {
  ...
  public static final String PARAM_WATERMARK_VARIABLE = "waterMarkVariable";
  ...
  static {
    ...
    dataTypeMap.put("groupConcat", new ArrayType(DataTypeUtils.OBJECT_TYPE));
  }
  ...
  public StreamAggregateDescriptor(FlowNodeMetadata flowNodeMetadata,
  ...
  protected ColumnSetMetadata compileCsmOfOutputPort(
    ...
    for (int i = 0; i < columns.length; i++) {
      ...
      //1为null,存储的是分组列
      if (null == column[1] && null != column[0]) {
