...
@OpDefiner(name = "Union",
    ...
    parameters =
        "<parameters><parametergroup name=\"general\" c_Alias=\"一般\" c_Compox=\"sightx-tab\">"
            + "<parameter name=\"delDup\" c_Option=\"false\" c_Alias=\"是否去重\" c_Compox =\"sightx-switch\">true</parameter>"
            + "</parametergroup>" + "</parameters>",
    compoxes = {})
public class UnionDescriptor extends AbstractProcessingDescriptor
    implements CompliationCsmDependent {

  public static final String PARAM_DE_DUPLICATION = "delDup";

  public UnionDescriptor(FlowNodeMetadata flowNodeMetadata, FlowNode parent,
