...
@OpDefiner(name = "Join",
    ...
    parameters =
        "<parameters><parametergroup name=\"general\" c_Alias=\"一般\" c_Compox=\"sightx-tab\">"
            ...
            + "</head>" + "</parametertable>"
            + "<parameter name=\"joinType\" c_Option=\"false\" c_Alias=\"连接类型\" c_Compox=\"sengee-join\">left</parameter>"
            + "</parametergroup>" + "</parameters>",
    compoxes = { @Compox(id = "sengee-join",
        parentId = "sightx-select",
        visibleDescriptors = {},
        dataDescriptor = @DataDesc(defaultValue = "left",
            data = "[{\"label\": \"inner\", \"value\": \"inner\"}, "
                + "{\"label\": \"left\", \"value\": \"left\"},{\"label\": \"right\", \"value\": \"right\"},"
                + "{\"label\": \"full\", \"value\": \"full\"}]"))
    })
public class JoinDescriptor extends AbstractProcessingDescriptor
  ...
  public JoinDescriptor(FlowNodeMetadata flowNodeMetadata, FlowNode parent,
  ...
  protected ColumnSetMetadata compileCsmOfOutputPort(
    ...
    String joinType = this.parameters.getParameterValue(PARAM_JOIN_TYPE);
