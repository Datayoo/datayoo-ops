...
public class HexEncodeDescriptor extends AbstractCodecDescriptor {

  public static final String COL_SUFFIX = "hex";

  public HexEncodeDescriptor(FlowNodeMetadata flowNodeMetadata, FlowNode parent,
