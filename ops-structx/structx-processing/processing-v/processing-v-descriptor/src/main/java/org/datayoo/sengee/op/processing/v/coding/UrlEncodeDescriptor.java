...
@OpDefiner(name = "UrlEncode",
    ...
    parameters =
        "<parameters><parametergroup name=\"general\" c_Alias=\"一般\" c_Compox=\"sightx-tab\">"
            ...
            + "<parametertable name=\"columnSet\" c_Alias=\"待编码列集合\" c_Compox=\"sengee-string-columns-selector\"><head>"
...
public class UrlEncodeDescriptor extends AbstractCodecDescriptor {

  public static final String COL_SUFFIX = "url";

  public UrlEncodeDescriptor(FlowNodeMetadata flowNodeMetadata, FlowNode parent,
