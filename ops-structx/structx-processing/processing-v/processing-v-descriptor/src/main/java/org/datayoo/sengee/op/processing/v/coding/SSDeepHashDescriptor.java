...
public class SSDeepHashDescriptor extends AbstractCodecDescriptor {

  public static final String COL_SUFFIX = "ssdeep";

  public SSDeepHashDescriptor(FlowNodeMetadata flowNodeMetadata,
