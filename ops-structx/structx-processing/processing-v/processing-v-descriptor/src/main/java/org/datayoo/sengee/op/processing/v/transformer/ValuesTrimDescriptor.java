...
@OpDefiner(name = "ValuesTrim",
    ...
    parameters =
        "<parameters><parametergroup name=\"general\" c_Alias=\"一般\" c_Compox=\"sightx-tab\">"
            + "<parametertable name=\"columnSet\" c_Alias=\"待修剪列集合\"><head>"
    ...
    compoxes = {})
public class ValuesTrimDescriptor extends AbstractProcessingDescriptor {

  public ValuesTrimDescriptor(FlowNodeMetadata flowNodeMetadata,
