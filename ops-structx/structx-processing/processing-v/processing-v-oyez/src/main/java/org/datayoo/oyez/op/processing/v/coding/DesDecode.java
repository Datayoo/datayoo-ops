...
import org.datayoo.sengee.op.processing.v.coding.DesDecodeDescriptor;
...
@OpDefiner(name = "DesDecode",
    ...
    parameters = "",
    compoxes = {})
public class DesDecode extends AbstractCodecOperator {
  protected Cipher cipher;

  public DesDecode(FlowNodeMetadata operatorMetadata, FlowNode parent,
  ...
  protected Object codec(Object data) throws Exception {
    ...
    if (data instanceof String) {
      ...
      return new String(cipher.doFinal(Hex.decodeHex(((String) data))));
    } else {
  ...
  protected String getColumnSuffix() {
    return DesDecodeDescriptor.COL_SUFFIX;
  }
